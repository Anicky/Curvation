...
var CanvasDisplay = require('./src/js/CanvasDisplay');
var fs = require("fs");
...
function init() {
    ...
    var canvasDisplay = new CanvasDisplay();
    canvasDisplay.context = context;
    canvasDisplay.width = 640;
    canvasDisplay.height = 480;
    game.display = canvasDisplay;
